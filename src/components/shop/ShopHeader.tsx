...
export function ShopHeader({ categories }: { categories: Cat[] }) {
  ...
  const allNav: Cat[] = [...categories, ...smartLinks];

  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-sabren-gray shadow-[0_2px_12px_-8px_rgba(17,17,17,0.12)]">
      {/* Barre utilitaire */}
